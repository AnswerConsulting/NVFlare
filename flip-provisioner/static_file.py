...
class StaticFileBuilder(Builder):
    def __init__(self, enable_byoc=False, config_folder="", app_validator="", docker_image="", client_server_port="", client_server_dns=""):
        ...
        self.client_server_dns = client_server_dns
    ...
    def _build_client(self, client, ctx):
        ...
        config["servers"][0]["service"]["target"] = f"{self.client_server_dns}:{self.client_server_port}"
